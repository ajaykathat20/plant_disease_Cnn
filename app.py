...
if(app_mode=="Home"):
    ...
    st.markdown("""
                ...
                ##### Importance of plant disease detection and monitoring
                The global population is more than double today what it was in 1970. Within a decade, the population is expected to be around 8.5 billion and almost 10 billion by 2050. With this growing population, agricultural production and crop yield have lost their pace to compete with the increasing demand in many places (Daszkiewicz, 2022). It has been estimated that 120 million ha of crops will be needed to feed the developing countries when no new lands will be added for agricultural purposes.
                """)
